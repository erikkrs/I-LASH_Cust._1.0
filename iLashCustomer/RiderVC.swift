...
class RiderVC: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate, UberController, MFMailComposeViewControllerDelegate {
    ...
    var toRecipient = ["dominic.saragaglia@i-lash.us"]
    ...
    func showMailError(){
        let sendMailErrorAlert = UIAlertController(title: "Could Not Send Email", message: "your device did not send the email", preferredStyle: .alert)
